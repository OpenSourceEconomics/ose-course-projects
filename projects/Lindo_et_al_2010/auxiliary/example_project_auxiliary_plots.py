...
def plot_RDD_curve_CI(
    ...
    plt.pyplot.plot(df_untreat[outcome], color=linecolor, label="_nolegend_")
    plt.pyplot.plot(df_treat[outcome], color=linecolor, label="_nolegend_")
